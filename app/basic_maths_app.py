...
def main():
    ...
    if nav == "Dashboard":
        ...
        with action_cols[0]:
            st.markdown(
                "<section class='bm-card' aria-label='Recommendations'><h2 style='margin-top:0;margin-bottom:0.35rem;font-size:1.05rem'>Recommendations</h2><p>Review the top topics the system suggests for your stage and goal.</p></section>",
                unsafe_allow_html=True,
            )
        with action_cols[1]:
            st.markdown(
